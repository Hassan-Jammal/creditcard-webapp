<template>
  ...
  >
    <!-- HEADER -->
    <div
      class="cursor-pointer flex items-center gap-4 justify-between font-bold text-xl"
      @click="toggle"
    >
      <span class="text-gray-500 text-lg whitespace-nowrap">
        {{ title }}
      </span>

      <Icon
        :name="isOpen ? 'fa7-solid:chevron-up' : 'fa7-solid:chevron-down'"
