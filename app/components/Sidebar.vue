<template>
    <div
        ...
        <div class="w-full flex flex-col gap-8 relative">
            ...
            <div v-for="(step, index) in steps" :key="step.id ?? index" @click="onStepClick(index)" :class="[
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div class="bg-white py-2">
                        <div :class="[
                            'w-[40px] h-[40px] flex items-center justify-center rounded-full shrink-0 text-2xl py-1 border-[2px]',
                            index === activeStep
