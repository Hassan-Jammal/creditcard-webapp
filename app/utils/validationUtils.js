...
export const isValidCheckboxSelection = (values, minRequired = 1) => {
    return Array.isArray(values) && values.length >= minRequired;
};

export const isValidRadioSelection = (value) => {
